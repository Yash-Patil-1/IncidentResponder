<div align="center">
  ...
  <p><strong>Automated IR Playbook Engine</strong></p>
  <p>
...
All action params support `{{alert.field}}` substitution:
...
<div align="center">
  <sub>Built with Python, PyYAML, SQLite, and a deep appreciation for automated defense.</sub>
  <br>
  <sub>Part of the <strong>Detect → Respond → Hunt</strong> SOC tool portfolio.</sub>
</div>
